...
let exportForAppHosting = exports.exportForAppHosting = (() => {
  var _ref11 = _asyncToGenerator(function* (projectRoot, publicUrl, assetUrl, outputDir, options = {}) {
    ...
    let { iosBundle, androidBundle } = yield _buildPublishBundlesAsync(projectRoot, packagerOpts);
    ...
    if (options.dumpSourcemap) {
      ...
      const iosMapPath = _path.default.join(outputDir, 'ios.map');
      const iosJsPath = _path.default.join(outputDir, 'ios.js');
      yield _writeArtifactSafelyAsync(projectRoot, null, iosMapPath, iosSourceMap);

      const androidMapPath = _path.default.join(outputDir, 'android.map');
      const androidJsPath = _path.default.join(outputDir, 'android.js');
...
let buildAsync = exports.buildAsync = (() => {
  ...
  return function buildAsync(_x59) {
    return _ref31.apply(this, arguments);
  };
})();

let _waitForRunningAsync = (() => {
  var _ref32 = _asyncToGenerator(function* (url) {
    try {
  ...
  return function _waitForRunningAsync(_x60) {
    return _ref32.apply(this, arguments);
  };
})();

let startReactNativeServerAsync = exports.startReactNativeServerAsync = (() => {
  var _ref33 = _asyncToGenerator(function* (projectRoot, options = {}, verbose = true) {
    _assertValidProjectRoot(projectRoot);
    ...
    let exitPromise = new Promise(function (resolve, reject) {
      packagerProcess.once('exit', (() => {
        var _ref34 = _asyncToGenerator(function* (code) {
  ...
  return function startReactNativeServerAsync(_x61) {
...
let stopReactNativeServerAsync = exports.stopReactNativeServerAsync = (() => {
  ...
  return function stopReactNativeServerAsync(_x63) {
...
let startExpoServerAsync = exports.startExpoServerAsync = (() => {
  var _ref36 = _asyncToGenerator(function* (projectRoot) {
    ...
    let manifestHandler = (() => {
      var _ref37 = _asyncToGenerator(function* (req, res) {
        try {
          ...
          yield _resolveManifestAssets(projectRoot, manifest, (() => {
            var _ref38 = _asyncToGenerator(function* (path) {
      ...
      return function manifestHandler(_x65, _x66) {
  ...
  return function startExpoServerAsync(_x64) {
    return _ref36.apply(this, arguments);
  };
})();

let stopExpoServerAsync = exports.stopExpoServerAsync = (() => {
  var _ref41 = _asyncToGenerator(function* (projectRoot) {
    _assertValidProjectRoot(projectRoot);
    let packagerInfo = yield (_ProjectSettings || _load_ProjectSettings()).readPackagerInfoAsync(projectRoot);
  ...
  return function stopExpoServerAsync(_x72) {
    return _ref41.apply(this, arguments);
  };
})();

let _connectToNgrokAsync = (() => {
  var _ref42 = _asyncToGenerator(function* (projectRoot, args, hostnameAsync, ngrokPid, attempts = 0) {
    try {
  ...
  return function _connectToNgrokAsync(_x73, _x74, _x75, _x76) {
...
let startTunnelsAsync = exports.startTunnelsAsync = (() => {
  ...
  return function startTunnelsAsync(_x77) {
    return _ref43.apply(this, arguments);
  };
})();

let stopTunnelsAsync = exports.stopTunnelsAsync = (() => {
  var _ref48 = _asyncToGenerator(function* (projectRoot) {
  ...
  return function stopTunnelsAsync(_x78) {
...
let setOptionsAsync = exports.setOptionsAsync = (() => {
  ...
  return function setOptionsAsync(_x79, _x80) {
...
let getUrlAsync = exports.getUrlAsync = (() => {
  ...
  return function getUrlAsync(_x81) {
    return _ref50.apply(this, arguments);
  };
})();

let startAsync = exports.startAsync = (() => {
  var _ref51 = _asyncToGenerator(function* (projectRoot, options = {}, verbose = true) {
    _assertValidProjectRoot(projectRoot);
  ...
  return function startAsync(_x82) {
...
let _stopInternalAsync = (() => {
  ...
  return function _stopInternalAsync(_x83) {
    return _ref52.apply(this, arguments);
  };
})();

let stopAsync = exports.stopAsync = (() => {
  var _ref53 = _asyncToGenerator(function* (projectDir) {
  ...
  return function stopAsync(_x84) {
